...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= $plat['presence'] ?></td>
            <td>
                <a id ="loginForm" href="index.php?ctrl=Plat&action=modifier&id=<?= $plat['id'] ?>">Modifier</a>
...
<button onclick="loadAjouter('Plat')">Ajouter</button>
<?php endif; ?>


<?php if (isset($A_vue['onRepas'])): ?>
<h1>Liste des Repas</h1>
<button onclick="loadLister('Repas')">Ajouter</button>
...
<?php if (isset($A_vue['onStructure'])): ?>
    ...
    <button onclick="loadAjouter('Structure')">Ajouter</button>
...
<?php if (isset($A_vue['onTenrac'])): ?>
    ...
    <button onclick="loadAjouter('Tenrac')">Ajouter</button>
